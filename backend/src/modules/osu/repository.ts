...
async function temporarilyStoreTokens(redis: RedisClient, tokens: {
  accessToken: string;
  refreshToken: string;
  tokenIssuedAt: number;
}, state: string, timeMs: number) {
...
export const osuRepository = { temporarilyStoreTokens, getTemporarilyStoredTokens, deleteTemporarilyStoredTokens };
